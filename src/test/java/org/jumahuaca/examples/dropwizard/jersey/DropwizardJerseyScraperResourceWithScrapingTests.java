...
public class DropwizardJerseyScraperResourceWithScrapingTests {
	...
	@Test			
	public void scrapOneMonthShouldReCreate() throws InterruptedException, ExecutionException, CloneNotSupportedException {
		MonthYear monthYear = new MonthYear(TEST_MONTH,TEST_YEAR);
		UVAScrapingProcess process = new UVAScrapingProcess();
		LocalDate from = LocalDate.of(monthYear.getYear(), monthYear.getMonth(), TEST_DAY);
		process.setFromDate(from);
	...
	private static Map<LocalDate,UVAExchange> fakeSomeUVAExchangesByDate() {
		...
		exchanges.put(LocalDate.parse("16/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("16/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.23)));
		exchanges.put(LocalDate.parse("15/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("15/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.61)));
		exchanges.put(LocalDate.parse("14/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("14/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.61)));
		exchanges.put(LocalDate.parse("13/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("13/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.6)));
		exchanges.put(LocalDate.parse("12/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("12/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.58)));
		exchanges.put(LocalDate.parse("11/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("11/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.57)));
		exchanges.put(LocalDate.parse("10/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("10/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.55)));
		exchanges.put(LocalDate.parse("09/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("09/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.51)));
		exchanges.put(LocalDate.parse("08/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("08/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.51)));
		exchanges.put(LocalDate.parse("07/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("07/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.51)));
		exchanges.put(LocalDate.parse("06/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("06/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.5)));
		exchanges.put(LocalDate.parse("05/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("05/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.48)));
		exchanges.put(LocalDate.parse("04/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("04/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.47)));
		exchanges.put(LocalDate.parse("03/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("03/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.46)));
		exchanges.put(LocalDate.parse("02/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("02/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.41)));
		exchanges.put(LocalDate.parse("01/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("01/05/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.41)));
		exchanges.put(LocalDate.parse("30/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("30/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.41)));
		exchanges.put(LocalDate.parse("29/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("29/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.4)));
		exchanges.put(LocalDate.parse("28/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("28/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.38)));
		exchanges.put(LocalDate.parse("27/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("27/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.37)));
		exchanges.put(LocalDate.parse("26/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("26/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.36)));
		exchanges.put(LocalDate.parse("25/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("25/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.32)));
		exchanges.put(LocalDate.parse("24/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("24/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.32)));
		exchanges.put(LocalDate.parse("23/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("23/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.32)));
		exchanges.put(LocalDate.parse("22/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("22/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.31)));
		exchanges.put(LocalDate.parse("21/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("21/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.29)));
		exchanges.put(LocalDate.parse("20/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("20/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.28)));
		exchanges.put(LocalDate.parse("19/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("19/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.27)));
		exchanges.put(LocalDate.parse("18/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("18/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.23)));
		exchanges.put(LocalDate.parse("17/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),new UVAExchange(LocalDate.parse("17/04/2016", DateTimeFormatter.ofPattern("dd/MM/yyyy")),
				BigDecimal.valueOf(14.23)));
		return exchanges;
	}
